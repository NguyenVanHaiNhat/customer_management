...
import org.example.customermanagement.model.service.CustomerService;
import org.example.customermanagement.model.service.CustomerServiceImpl;
...
public class CustomerServlet extends HttpServlet {
    ...
    private void updateCustomer(HttpServletRequest req, HttpServletResponse resp) {
        ...
        if (customer == null){
            ...
            req.setAttribute("message", "customer information was update");
